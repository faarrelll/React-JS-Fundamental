...
function ErrorBoundariesFallbackPage() {
      ...
      <div className="bg-white shadow-xl rounded-lg p-6 max-w-2xl w-full">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <button
            ...
            className="flex items-center justify-center bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 transition-colors"
          >
...
export default ErrorBoundariesFallbackPage;
